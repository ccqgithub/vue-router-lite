...
var MemoryRouter = {
  ...
  data: function data() {
    var history = history$1.createMemoryHistory({
...
var HashRouter = {
  ...
  data: function data() {
    var history = history$1.createHashHistory({
...
var createURL = function createURL(location) {
  return typeof location === "string" ? location : history$1.createPath(location);
};
...
var StaticRouter = {
  ...
  computed: {
    childProps: function childProps() {
      ...
      var history = {
        action: "POP",
        location: stripBasename(basename, history$1.createLocation(location)),
        go: staticHandler("go"),
  ...
  methods: {
    ...
    handlePush: function handlePush(location) {
      var basename = this.basename,
          context = this.context;
      context.action = "PUSH";
      context.location = addBasename(basename, history$1.createLocation(location));
...
var Redirect = {
  ...
  updated: function updated() {
    ...
    if (history$1.locationsAreEqual(this.lastTo, to)) {
      return;
    }
  ...
  methods: {
    ...
    computeTo: function computeTo() {
      var _this$$route = this.$route,
          match = _this$$route.match,
          location = _this$$route.location; // to
      ...
      var to = history$1.createLocation(p);
      return to;
    },
...
var normalizeToLocation = function normalizeToLocation(to, currentLocation) {
  return typeof to === "string" ? history$1.createLocation(to, null, null, currentLocation) : to;
};
var Link = {
  components: {
    Tag: Tag
