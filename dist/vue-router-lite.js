...
const MemoryRouter = {
  ...
  data() {
    let history$1 = history.createMemoryHistory({
...
const HashRouter = {
  ...
  data() {
    let history$1 = history.createHashHistory({
...
const createURL = location => typeof location === "string" ? location : history.createPath(location);
...
const Redirect = {
  ...
  methods: {
    ...
    computeTo() {
      ...
      const to = history.createLocation(p);
      return to;
    },
