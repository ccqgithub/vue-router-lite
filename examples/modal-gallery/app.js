...
const App = {
  ...
  template: `
    <div class="app">
      <h1>Modal Gallery 1: RouteSwitch</h1>
      <hr />
      <route-switch :location="isModal ? previousLocation : location">
        <route 
          exact 
          path="/" 
          v-slot="props"
      ...
      <route path="/img/:id" v-slot="props" v-if="isModal">
        <modal v-bind="props" />
      </route>
    </div>
  `
...
new Vue({
  ...
  template: `
    <router basename="/modal-gallery/" v-slot="slotProps">
